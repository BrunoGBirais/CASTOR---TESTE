# 545f03fb-dc81-416d-bdf8-f09d7540e80f implementation handoff

This archive is the source of truth for turning the design into production code. Start from `balancas-navarro-login-react.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
- A single self-contained `balancas-navarro-login-react.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `balancas-navarro-login-react.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
## Entry points
- `balancas-navarro-login-react.html`
- `balancas-navarro-login.html`
...
- `err.log`
- `err2.log`
- `hero-navarro-galpao-BcRxo_pu.jpg`
- `LAYOUT-SPEC.md`
- `LOGIN-SCREEN-CONTEXT.md`
- `logo-navarro.png`
- `logo-rodape-jia-sp-1.png`
- `logo-rodape-jia-sp.png`
- `out.log`
- `out2.log`
- `screenshot-2026-08-06T12-38-16-714Z.png`
- `screenshot-2026-08-06T12-38-31-252Z.png`
- `screenshot-2026-08-11T13-24-00-682Z.png`
- `sketch-2026-08-06T14-55-00.sketch.json`

## Coding checklist for AI tools
1. Inspect `balancas-navarro-login-react.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
